...
public:
    ...
    // 勿扰模式相关方法
    virtual void EnableDndMode(bool enable) = 0;
    virtual bool IsDndModeEnabled() const = 0;
    virtual bool HasPendingWakeWord() const = 0;
    virtual void ClearPendingWakeWord() = 0;
    virtual void SignalWakeWord() = 0;
